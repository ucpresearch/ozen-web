...
subtitle: "Install and run Ozen-web in 5 minutes"
---
...
::: {.tutorial-steps}
1. **Drag and drop** a WAV, MP3, or OGG file onto the interface

   OR

   **Click "Load Audio"** button and select a file

2. Wait for the waveform to appear (1-2 seconds for typical files)
...
| Backend | Source | License | Speed | Offline |
|---------|--------|---------|-------|---------|
| `praatfan-local` | `static/wasm/` | MIT/Apache-2.0 | Fastest | ✅ Yes |
| `praatfan` | GitHub Pages CDN | MIT/Apache-2.0 | Fast | ❌ No |
| `praatfan-gpl` | GitHub Pages CDN | GPL | Fast | ❌ No |
