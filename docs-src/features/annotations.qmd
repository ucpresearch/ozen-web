...
**Drag and drop:**
1. Drag `.TextGrid` file onto interface
2. Annotations load automatically
3. Audio must be loaded separately
...
- Recommended: Match audio filename (e.g., `recording.wav` → `recording.TextGrid`)
