...
Acoustic overlays display computed measurements directly on the spectrogram, enabling visual analysis of prosody, voice quality, and spectral properties. All computations use Praat-accurate algorithms via WebAssembly.
...
See [URL Parameters](../embedding/url-parameters.html) for details.
...
| Overlay | Computation Time (30s audio) |
|---------|------------------------------|
| Pitch | ~100-150 ms |
| Formants | ~200-300 ms |
| Intensity | ~80-120 ms |
