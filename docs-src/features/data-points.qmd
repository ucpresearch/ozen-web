...
- Press <kbd>Ctrl+C</kbd> (Windows/Linux) or <kbd>Cmd+C</kbd> (Mac) to copy all data points as TSV to clipboard
- Paste directly into spreadsheet software or text editor
...
**Workflow:**
1. Load audio with /s/, /ʃ/ contrasts
...
3. Double-click spectrogram to add point
4. Repeat
...
Data point operations enable rapid collection workflows.
