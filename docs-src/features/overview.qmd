...
Ozen-web is a browser-based tool for acoustic analysis and
annotation. This page provides an overview of all major features with
...
Praatfan-local and praatfan are identical, and approximate
praatfan-gpl, which was built to be very similar to Praat. Select via
dropdown in the app interface.
