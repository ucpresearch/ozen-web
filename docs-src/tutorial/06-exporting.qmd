...
- **[Features Documentation](../features/overview.html)** — Deep dive into all features
- **[Keyboard Shortcuts Reference](../reference/keyboard-shortcuts.html)** — Speed up your workflow
- **[Configuration Guide](../reference/configuration.html)** — Customize default settings
- **[Embedding Guide](../embedding/overview.html)** — Embed ozen-web in websites or documents
...
**Navigation:**
[← Previous: Data Collection](05-data-collection.html) | [Tutorial Overview](index.html) | [Features Documentation →](../features/overview.html)
