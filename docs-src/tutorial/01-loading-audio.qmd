...
- **Hosted version**: [https://ucpresearch.github.io/ozen-web/](https://ucpresearch.github.io/ozen-web/)
...
::: {.callout-note}
The file picker shows only supported formats (WAV, MP3, OGG, M4A, FLAC). If your file doesn't appear, check the format or try "All Files" filter.
:::
...
::: {.callout-try}
Try recording yourself saying a few vowels ("ah", "ee", "oo") to see clear formant patterns in the spectrogram.
:::
...
| **OGG** | `.ogg`, `.oga` | ✅ Open format, good quality |
| **M4A** | `.m4a` | ⚠️ Browser-dependent (works in Safari/Chrome) |
| **FLAC** | `.flac` | ⚠️ Browser-dependent (Chrome/Edge only) |
