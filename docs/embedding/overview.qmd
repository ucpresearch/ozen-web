...
**See:** [URL Parameters Reference](url-parameters.qmd) for all available options
...
```
my-project/
├── document.qmd                # Your Quarto document
...
**See:** [Helper Scripts Documentation](basic-usage.qmd#helper-scripts)
...
**See:** [Examples Page](examples.qmd) for more use cases
...
**See:** [Getting Started: Deployment](../getting-started.qmd#option-3-deploy-your-own-instance)
...
**See:** [Basic Usage: Serving Documents](basic-usage.qmd#serving-documents)
...
**See:** [URL Parameters: CORS](url-parameters.qmd#cors-requirements)

## Next Steps

- **[Basic Usage](basic-usage.qmd)** — Detailed embedding instructions
- **[Quarto Integration](quarto-integration.qmd)** — Quarto-specific guide
- **[URL Parameters](url-parameters.qmd)** — Complete parameter reference
- **[Examples](examples.qmd)** — Working examples for all use cases
...
A: Yes, via `config.yaml` file in the `ozen-web/` directory. See [Configuration Reference](../reference/configuration.qmd).
